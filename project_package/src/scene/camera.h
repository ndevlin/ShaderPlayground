...
public:
    ...
    glm::vec3 eye,      //The position of the camera in world space
              ...
              look,     //The normalized vector from eye to ref/"forward" vector.
              up,       //The normalized vector pointing upwards IN CAMERA SPACE. Perpendicular to LOOK and RIGHT.
              right,    //The normalized vector pointing rightwards IN CAMERA SPACE. Perpendicular to UP and LOOK.
              world_up, //The normalized vector pointing upwards IN WORLD SPACE. Primarily used for computing the camera's initial UP vector.
